<?php
/*
  Plugin Name: Miembros de ENA
  Plugin URI: http://github.com/encuentroena
  Description: Plugin para gestionar miembros de ENA (Basado en WP Markers)
  Version: 1.1.1
  License: GPLv2
 */
...
function wpmm_plugin_setup() {
	...
	add_shortcode( 'wpmm_map_single', 'wpmm_do_display_map_single' );	
...
function wpmm_fetch_stores_single( $map, $id ) {
